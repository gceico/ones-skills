...
1. Install: `/plugin install scira@ones-skills`
2. Copy `scira.config.example.md` → `scira.config.md` and fill it.
...
content calendar. SCIRA finds, measures, distills, and ideates; you decide what to write and write it.
